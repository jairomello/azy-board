...
Esta matriz oferece uma visão rápida das capacidades do Azy Board e indica onde cada assunto é explicado.

| Área | Capacidades | Módulo do manual |
|---|---|---|
...
| Histórias | Narrativa ágil, critérios, notas, versão e lane interna do Board | [[05 - Epicos e Historias/Criar e Detalhar Historias|Criar e detalhar histórias]] |
| Tasks e bugs | Detalhes, estimativa, datas, responsáveis e classificação | [[06 - Tasks Bugs e Subtasks/Criar e Editar Tasks e Bugs|Criar e editar tasks e bugs]] |
| Subtasks | Criação, navegação entre filhos e progresso consolidado | [[06 - Tasks Bugs e Subtasks/Organizar Subtasks e Navegar entre Filhos|Organizar subtasks e navegar entre filhos]] |
| Checklists | Listas, itens, conclusão e progresso | [[06 - Tasks Bugs e Subtasks/Checklists|Checklists]] |
| Atividades | Histórico automático, registros manuais e duração | [[06 - Tasks Bugs e Subtasks/Historico de Atividades e Tempo Trabalhado|Histórico e tempo trabalhado]] |
| Anexos | Upload, consulta e remoção de arquivos | [[06 - Tasks Bugs e Subtasks/Anexos|Anexos]] |
| Arquivamento | Arquivamento em cascata, consulta e restauração | [[04 - Board e Visualizacoes/Arquivar Restaurar e Excluir Itens|Arquivar, restaurar e excluir itens]] |
| Pessoas | Gerente, membros e papéis | [[07 - Configuracoes do Projeto/Gerenciar Membros e Papeis|Gerenciar membros e papéis]] |
| Squads | Equipes, estrutura organizacional e filtro do Board | [[07 - Configuracoes do Projeto/Organizar Squads e Consultar a Estrutura|Organizar squads e consultar a estrutura]] |
| Board configurável | Colunas, status base, renomeação e exclusão | [[07 - Configuracoes do Projeto/Gerenciar Colunas do Board|Gerenciar colunas do Board]] |
| Módulos | Agrupamentos, ordem e tratamento dos épicos na exclusão | [[07 - Configuracoes do Projeto/Gerenciar Modulos|Gerenciar módulos]] |
| Centros de custo | Classificação financeira e atribuição aos itens | [[07 - Configuracoes do Projeto/Gerenciar Centros de Custo|Gerenciar centros de custo]] |
