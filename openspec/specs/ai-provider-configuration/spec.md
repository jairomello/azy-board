...
O sistema SHALL permitir que usuário `ROOT` configure, teste, ative, substitua e revogue uma configuração OpenAI por tenant, com modelo, API key e parâmetros operacionais validados.
