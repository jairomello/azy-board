...
O sistema SHALL exibir filtros no toolbar do board organizados em zonas visuais. Os toggles de estado (Mostrar subtasks, Histórias no board, Ocultar épicos vazios) SHALL ser exibidos como ícones com tooltip. Os filtros de conteúdo com valor selecionável (Squad, Módulo, Responsável, tipos) SHALL manter label visível por necessidade de legibilidade do valor ativo. As ações "Expandir tudo" e "Recolher tudo" SHALL ser ícones com tooltip.
