...
O workflow SHALL executar gates que detectam divergencia de contratos antes do merge: verificacao de i18n, testes de migration, validacao do catalogo MCP e verificacao da skill de agente. Qualquer divergencia SHALL reprovar o job correspondente.
