...
#### Scenario: Estado vazio de versão em projeto sem versões
- **WHEN** o usuário abre um projeto sem versões cadastradas
- **THEN** o estado persistido mantém `versionId` vazio e o filtro continua disponível sem ativar contagem de filtro
